    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">💰 매매비용 계산기</h1>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-6">매매 정보 입력</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="firstHome" className="ml-2 text-sm text-gray-700">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label htmlFor="multipleHomes" className="ml-2 text-sm text-gray-700">
                    다주택자 (중과세 20% 추가)
                  </label>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-blue-50 rounded-lg p-4">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600">
                      매매가 대비 {((result.totalCost / parseFloat(propertyPrice.replace(/,/g, ''))) * 100).toFixed(2)}%
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center py-2 border-b border-gray-200">
                    ...
                    <span className="font-medium">{formatNumber(result.breakdown.acquisitionTax)}원</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-200">
                    <span className="text-gray-700">등록세</span>
                    <span className="font-medium">{formatNumber(result.breakdown.registrationTax)}원</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-200">
                    <span className="text-gray-700">교육세</span>
                    <span className="font-medium">{formatNumber(result.breakdown.educationTax)}원</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-200">
                    <span className="text-gray-700">인지세</span>
                    <span className="font-medium">{formatNumber(result.breakdown.stampTax)}원</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-200">
                    <span className="text-gray-700">중개수수료</span>
                    <span className="font-medium">{formatNumber(result.breakdown.brokerageFee)}원</span>
                  </div>
                  <div className="flex justify-between items-center py-2">
                    <span className="text-gray-700">기타 비용</span>
                    <span className="font-medium">{formatNumber(result.breakdown.otherFees)}원</span>
                  </div>
                </div>
              </div>
            ) : (
        ...
        <div className="mt-8 bg-yellow-50 border border-yellow-200 rounded-lg p-6">
          ...
          <ul className="text-sm text-yellow-700 space-y-2">
            ...
            <li>• 실제 거래 시에는 지역별 세율 차이, 특별할인 등이 적용될 수 있습니다.</li>
            <li>• 정확한 계산을 위해서는 관할 세무서나 부동산 전문가와 상담하시기 바랍니다.</li>
