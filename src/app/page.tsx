...
import { BannerAd, ResponsiveAd } from 'src/components/ad-sense'
import NaverMap from 'src/components/naver-map'
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            매매비용, DSR 계산, 청약 정보까지 한 번에 확인하세요.
            <br />
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
          ...
          <p className="text-gray-600 text-center mb-6">
            지도에서 원하는 지역의 부동산 위치를 확인하고 주변 시세를
            파악해보세요
          </p>
      ...
      <footer className="bg-gray-800 text-white py-8 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-400 text-sm">
            © 2024 부동산 계산기. 모든 계산 결과는 참고용이며, 실제 거래 시에는
            전문가와 상담하시기 바랍니다.
          </p>
        </div>
      </footer>
